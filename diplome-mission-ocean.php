...
$pdf->SetAutoPageBreak(true);
    ...
    if($sexe=="fille"){
    //pdf source fille
        $pdf->setSourceFile('./diplomes/diplomeOceanFille.pdf');
    }else{ 
    //pdf source garçon
        $pdf->setSourceFile('./diplomes/diplomeOceanGarçon.pdf');
    };  
...
$pdf->SetXY(0, 0);
//texte nom et prénom
$pdf->Cell(290, 153,  utf8_decode($prenom.' '.$nom), 0, 2, 'C');


//date du jour
$pdf->SetFont('Lato', 'B', 25);
$pdf->Cell(280,57, $date, 0, 0, 'R');
